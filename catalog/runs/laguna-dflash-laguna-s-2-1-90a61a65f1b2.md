# `laguna-dflash/dflash-k15/medium-4096x256-c4`
...
| metric | value |
|---|---:|
| `output_tok_s` | 60.171065863701955 |
| `decode_tok_s` | 21.891772733380762 |
| `prefill_tok_s` | 1304.7042175211955 |
| `total_tok_s` | 1029.4893300117756 |
| `req_s` | 0.23504322603008576 |
| `ttft_p50_ms` | 5126.916559529491 |
| `ttft_p99_ms` | 9165.527907630894 |
| `itl_p50_ms` | 73.42960697133094 |
| `tpot_p50_ms` | 45.174780423415136 |
| `e2e_p99_ms` | 23757.520210845396 |
| `vram_peak_mib` | 96022 |
| `avg_power_w` | 792.3457777777777 |
| `max_temp_c` | 74.0 |
...
```json
{
  "acceptance": 0.09109826589595375,
  "accepted_tokens_per_round": 1.3664739884393065,
...
```json
{
  ...
  "num_prompts": 8,
  "output_tok_per_watt": 0.07594041332870913,
  "prefix_hit_rate": 0.0038797284190106693,
  "throttle_sample_count": 140
}
```

## Provenance

- `repo:llm-bench/results/daily-papers/2026-07-22/laguna-s-2.1-dflash-4x3090/dflash-k15/medium-4096x256-c4.json`
