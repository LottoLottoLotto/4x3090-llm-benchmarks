# `laguna-dflash/dflash-k15/depth-65536x256-c1`
...
| metric | value |
|---|---:|
| `output_tok_s` | 5.7849465984185215 |
| `decode_tok_s` | 53.83154692517289 |
| `prefill_tok_s` | 1675.7647976925668 |
| `total_tok_s` | 1487.680368594863 |
| `req_s` | 0.02259744765007235 |
| `ttft_p50_ms` | 39515.16940398142 |
| `ttft_p99_ms` | 39515.16940398142 |
| `itl_p50_ms` | 41.23775556217879 |
| `tpot_p50_ms` | 18.576467835673075 |
| `e2e_p99_ms` | 44252.16870207805 |
| `vram_peak_mib` | 96036 |
| `avg_power_w` | 799.9101785714286 |
| `max_temp_c` | 75.0 |
...
```json
{
  "acceptance": 0.07863247863247863,
  "accepted_tokens_per_round": 1.1794871794871795,
...
```json
{
  ...
  "num_prompts": 1,
  "output_tok_per_watt": 0.007231995233202237,
  "prefix_hit_rate": 0.00024398426301503552,
  "throttle_sample_count": 180
}
```

## Provenance

- `repo:llm-bench/results/daily-papers/2026-07-22/laguna-s-2.1-dflash-4x3090/dflash-k15/depth-65536x256-c1.json`
