# `tpab/Qwen3.6-27B/FP8-static_tp4_aggregate_c64`
...
|---|---:|
| `output_tok_s` | 293.01 |
| `ttft_p50_ms` | 16880.03 |

## Launch command

```bash
'${ENGINE_ROOT}/vllm-env/bin/vllm' serve '${MODEL_ROOT}/Qwen3.6-27B-FP8' --host 127.0.0.1 --port 18001 --served-model-name bench --tensor-parallel-size 4 --max-model-len 32768 --gpu-memory-utilization 0.90 --trust-remote-code --max-num-seqs 256 --enable-chunked-prefill
```
