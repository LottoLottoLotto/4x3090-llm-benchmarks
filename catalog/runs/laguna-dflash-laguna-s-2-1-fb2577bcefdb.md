# `laguna-dflash/dflash-k7/short-512x256-c4`
...
| metric | value |
|---|---:|
| `output_tok_s` | 132.6716792366578 |
| `decode_tok_s` | 38.04498437447956 |
| `prefill_tok_s` | 1104.2620967595967 |
| `total_tok_s` | 415.279199095017 |
| `req_s` | 0.5182487470181946 |
| `ttft_p50_ms` | 436.9479615124874 |
| `ttft_p99_ms` | 1218.4497600770555 |
| `itl_p50_ms` | 62.13054450927302 |
| `tpot_p50_ms` | 27.20159419022464 |
| `e2e_p99_ms` | 9464.216764847515 |
| `vram_peak_mib` | 93758 |
| `avg_power_w` | 789.5419047619048 |
| `max_temp_c` | 73.0 |
...
```json
{
  "acceptance": 0.21809582201979505,
  "accepted_tokens_per_round": 1.5266707541385653,
...
```json
{
  ...
  "num_prompts": 16,
  "output_tok_per_watt": 0.16803627323196538,
  "prefix_hit_rate": 0.029340974212034385,
  "throttle_sample_count": 123
}
```

## Provenance

- `repo:llm-bench/results/daily-papers/2026-07-22/laguna-s-2.1-dflash-4x3090/dflash-k7/short-512x256-c4.json`
