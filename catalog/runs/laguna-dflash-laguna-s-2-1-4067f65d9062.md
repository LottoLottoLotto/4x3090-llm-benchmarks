# `laguna-dflash/dflash-k15/depth-131072x256-c1`
...
| metric | value |
|---|---:|
| `output_tok_s` | 2.8748203627350155 |
| `decode_tok_s` | 105.77634625539935 |
| `prefill_tok_s` | 1526.8039169411259 |
| `total_tok_s` | 1475.254496298824 |
| `req_s` | 0.011229767041933654 |
| `ttft_p50_ms` | 86637.54092995077 |
| `ttft_p99_ms` | 86637.54092995077 |
| `itl_p50_ms` | 42.61191649129614 |
| `tpot_p50_ms` | 9.453909455195944 |
| `e2e_p99_ms` | 89048.28784102574 |
| `vram_peak_mib` | 96036 |
| `avg_power_w` | 823.9022549019608 |
| `max_temp_c` | 76.0 |
...
```json
{
  "acceptance": 0.2311111111111111,
  "accepted_tokens_per_round": 3.466666666666667,
...
```json
{
  ...
  "num_prompts": 1,
  "output_tok_per_watt": 0.0034892735705367153,
  "prefix_hit_rate": 0.0,
  "throttle_sample_count": 355
}
```

## Provenance

- `repo:llm-bench/results/daily-papers/2026-07-22/laguna-s-2.1-dflash-4x3090/dflash-k15/depth-131072x256-c1.json`
