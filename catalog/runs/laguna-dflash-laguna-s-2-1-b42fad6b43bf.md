# `laguna-dflash/dflash-k15/medium-4096x256-c64`
...
| metric | value |
|---|---:|
| `output_tok_s` | 71.19964338647249 |
| `decode_tok_s` | 5.505597944115691 |
| `prefill_tok_s` | 1077.3580068243766 |
| `total_tok_s` | 1221.0582396251107 |
| `req_s` | 0.27812360697840816 |
| `ttft_p50_ms` | 177100.98723345436 |
| `ttft_p99_ms` | 212989.6454163047 |
| `itl_p50_ms` | 621.006918954663 |
| `tpot_p50_ms` | 192.62211507839135 |
| `e2e_p99_ms` | 266821.52916384744 |
| `vram_peak_mib` | 95156 |
| `avg_power_w` | 857.626476793249 |
| `max_temp_c` | 75.0 |
...
```json
{
  "acceptance": 0.09825510076354989,
  "accepted_tokens_per_round": 1.4738265114532483,
...
```json
{
  ...
  "num_prompts": 128,
  "output_tok_per_watt": 0.0830194091636432,
  "prefix_hit_rate": 0.0009585305503748672,
  "throttle_sample_count": 1836
}
```

## Provenance

- `repo:llm-bench/results/daily-papers/2026-07-22/laguna-s-2.1-dflash-4x3090/high-concurrency/dflash-k15/medium-4096x256-c64.json`
