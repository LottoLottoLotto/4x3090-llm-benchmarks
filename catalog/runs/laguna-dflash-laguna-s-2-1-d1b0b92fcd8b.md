# `laguna-dflash/dflash-k15/short-512x256-c1`
...
| metric | value |
|---|---:|
| `output_tok_s` | 57.8020846769508 |
| `decode_tok_s` | 62.26495491132477 |
| `prefill_tok_s` | 1723.499241565637 |
| `total_tok_s` | 180.34927787388457 |
| `req_s` | 0.22578939326933906 |
| `ttft_p50_ms` | 329.05467750970274 |
| `ttft_p99_ms` | 350.6292562233284 |
| `itl_p50_ms` | 40.34541209693998 |
| `tpot_p50_ms` | 16.943667884276927 |
| `e2e_p99_ms` | 5439.9367927678395 |
| `vram_peak_mib` | 92076 |
| `avg_power_w` | 796.2004347826087 |
| `max_temp_c` | 73.0 |
...
```json
{
  "acceptance": 0.10399670374948496,
  "accepted_tokens_per_round": 1.5599505562422744,
...
```json
{
  ...
  "num_prompts": 8,
  "output_tok_per_watt": 0.07259740406036433,
  "prefix_hit_rate": 0.02947950253339475,
  "throttle_sample_count": 142
}
```

## Provenance

- `repo:llm-bench/results/daily-papers/2026-07-22/laguna-s-2.1-dflash-4x3090/dflash-k15/short-512x256-c1.json`
