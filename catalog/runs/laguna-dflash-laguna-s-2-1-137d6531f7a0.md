# `laguna-dflash/dflash-k7/prefix-cold-32768x64`
...
| metric | value |
|---|---:|
| `output_tok_s` | 3.423669521072237 |
| `decode_tok_s` | 78.54796559137299 |
| `prefill_tok_s` | 1853.131958430433 |
| `total_tok_s` | 1758.5892474332613 |
| `req_s` | 0.053494836266753706 |
| `ttft_p50_ms` | 17890.695664915256 |
| `ttft_p99_ms` | 17890.695664915256 |
| `itl_p50_ms` | 29.235986061394215 |
| `tpot_p50_ms` | 12.731074477501569 |
| `e2e_p99_ms` | 18692.753356997855 |
| `vram_peak_mib` | 96448 |
| `avg_power_w` | 745.0723333333333 |
| `max_temp_c` | 74.0 |
...
```json
{
  "acceptance": 0.17733990147783252,
  "accepted_tokens_per_round": 1.2413793103448276,
...
```json
{
  ...
  "num_prompts": 1,
  "output_tok_per_watt": 0.004595083413922099,
...
- `repo:llm-bench/results/daily-papers/2026-07-22/laguna-s-2.1-dflash-4x3090/dflash-k7/prefix-cold-32768x64.json`
