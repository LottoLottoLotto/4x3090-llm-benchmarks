# `tpab/Qwen3.6-27B/autoround-int4_tp4_aggregate_c64`
...
|---|---:|
| `output_tok_s` | 294.76 |
| `ttft_p50_ms` | 16324.21 |

## Launch command

```bash
'${ENGINE_ROOT}/vllm-env/bin/vllm' serve '${MODEL_ROOT}/qwen3.6-27b-autoround-int4' --host 127.0.0.1 --port 18001 --served-model-name bench --tensor-parallel-size 4 --max-model-len 32768 --gpu-memory-utilization 0.90 --trust-remote-code --max-num-seqs 256 --enable-chunked-prefill
```
