# `exl3-ab/exllamav3-0.0.43/043_tp_ctx32768`
...
```bash
python exl3_bench.py --model ${MODEL_ROOT}/Qwen3.6-27B-exl3-6.0bpw --mode tp --ctx 32768 --gen 256 --repeats 3 --cache-size 40960 --cache-mode q8
```
...
- `rig:~/benchmarks/exl3-ab/raw/043_tp_ctx32768.json`
