# `dflash-compat/BF16/bf16-dflash/ctx512`
...
| metric | value |
|---|---:|
| `output_tok_s` | 120.95226354887299 |
| `decode_tok_s` | 120.95226354887299 |
| `prefill_tok_s` | 848.2496965368657 |
| `ttft_p50_ms` | 606.1551570892334 |
