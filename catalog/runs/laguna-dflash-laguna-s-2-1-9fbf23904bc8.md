# `laguna-dflash/dflash-k15/generation-512x64-c1`
...
| metric | value |
|---|---:|
| `output_tok_s` | 41.3137856852766 |
| `decode_tok_s` | 51.89736100052991 |
| `prefill_tok_s` | 1756.4329462350504 |
| `total_tok_s` | 398.9362430234521 |
| `req_s` | 0.6455279013324469 |
| `ttft_p50_ms` | 337.91711600497365 |
| `ttft_p99_ms` | 344.895917911781 |
| `itl_p50_ms` | 38.995326962322 |
| `tpot_p50_ms` | 19.18011662709187 |
| `e2e_p99_ms` | 1770.6762252515182 |
| `vram_peak_mib` | 96036 |
| `avg_power_w` | 664.8164705882352 |
| `max_temp_c` | 73.0 |
...
```json
{
  "acceptance": 0.06989247311827956,
  "accepted_tokens_per_round": 1.0483870967741935,
...
```json
{
  ...
  "num_prompts": 4,
  "output_tok_per_watt": 0.06214314402999344,
  "prefix_hit_rate": 0.021660649819494584,
  "throttle_sample_count": 27
}
```

## Provenance

- `repo:llm-bench/results/daily-papers/2026-07-22/laguna-s-2.1-dflash-4x3090/dflash-k15/generation-512x64-c1.json`
