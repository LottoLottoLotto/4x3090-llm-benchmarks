# `dflash-compat/unknown/autoround-dflash-256k/ctx261888`
...
| metric | value |
|---|---:|
| `output_tok_s` | 2.6379771651071344 |
| `decode_tok_s` | 2.6379771651071344 |
| `prefill_tok_s` | 690.2036071986719 |
| `ttft_p50_ms` | 379467.9071903229 |
...
- `rig:~/benchmarks/dflash-quant-compat/autoround-dflash-256k.results.json`
