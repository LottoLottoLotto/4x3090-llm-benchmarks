# `laguna-dflash/dflash-k7/prefix-warm-131072x64`
...
| metric | value |
|---|---:|
| `output_tok_s` | 41.846045488166055 |
| `decode_tok_s` | 85.96222662017757 |
| `prefill_tok_s` | 323.97140655671535 |
| `total_tok_s` | 85710.50882667537 |
| `req_s` | 0.6538444607525946 |
| `ttft_p50_ms` | 795.8320949692279 |
| `ttft_p99_ms` | 795.8320949692279 |
| `itl_p50_ms` | 31.025024014525115 |
| `tpot_p50_ms` | 11.63301649244709 |
| `e2e_p99_ms` | 1528.7121339933947 |
| `vram_peak_mib` | 96448 |
| `avg_power_w` | 558.0057142857142 |
| `max_temp_c` | 71.0 |
...
```json
{
  "acceptance": 0.18877551020408162,
  "accepted_tokens_per_round": 1.3214285714285714,
...
```json
{
  ...
  "num_prompts": 1,
  "output_tok_per_watt": 0.07499214509251374,
  "prefix_hit_rate": 0.999763400319028,
  "throttle_sample_count": 6
}
```

## Provenance

- `repo:llm-bench/results/daily-papers/2026-07-22/laguna-s-2.1-dflash-4x3090/dflash-k7/prefix-warm-131072x64.json`
