# `exl3-ab/exllamav3-1.0.0/100_tp_ctx2048`
...
```bash
python exl3_bench.py --model ${MODEL_ROOT}/Qwen3.6-27B-exl3-6.0bpw --mode tp --ctx 2048 --gen 256 --repeats 3 --cache-size 8192 --cache-mode q8
```
...
- `rig:~/benchmarks/exl3-ab/raw/100_tp_ctx2048.json`
