# `exl3-ab/exllamav3-1.0.0/cb_mul1_single_ctx2048`
...
```bash
python exl3_bench.py --model ${MODEL_ROOT}/Qwen3.6-27B-exl3-6.0bpw-mul1-v100 --mode single --ctx 2048 --gen 256 --repeats 3 --cache-size 8192 --cache-mode q8
```
...
- `rig:~/benchmarks/exl3-ab/raw/cb_mul1_single_ctx2048.json`
