# `laguna-dflash/dflash-k7/generation-512x1024-c1`
...
| metric | value |
|---|---:|
| `output_tok_s` | 121.2586909116925 |
| `decode_tok_s` | 125.88807854228561 |
| `prefill_tok_s` | 1741.8923418136271 |
| `total_tok_s` | 184.3451826921653 |
| `req_s` | 0.1184166903434497 |
| `ttft_p50_ms` | 320.91006002156064 |
| `ttft_p99_ms` | 334.4571366091259 |
| `itl_p50_ms` | 28.63078797236085 |
| `tpot_p50_ms` | 8.227092554241525 |
| `e2e_p99_ms` | 10863.680850537494 |
| `vram_peak_mib` | 96448 |
| `avg_power_w` | 804.5011904761906 |
| `max_temp_c` | 73.0 |
...
```json
{
  "acceptance": 0.3748894783377542,
  "accepted_tokens_per_round": 2.6242263483642794,
...
```json
{
  ...
  "num_prompts": 4,
  "output_tok_per_watt": 0.15072530948017432,
  "prefix_hit_rate": 0.03003284842796809,
  "throttle_sample_count": 133
}
```

## Provenance

- `repo:llm-bench/results/daily-papers/2026-07-22/laguna-s-2.1-dflash-4x3090/dflash-k7/generation-512x1024-c1.json`
