# `exl3-ab/exllamav3-1.0.0/100noqc_tp_ctx8192`
...
```bash
python exl3_bench.py --model ${MODEL_ROOT}/Qwen3.6-27B-exl3-6.0bpw --mode tp --ctx 8192 --gen 256 --repeats 3 --cache-size 16384 --cache-mode q8   [env: EXL3_QC_ATTN=0]
```
...
- `rig:~/benchmarks/exl3-ab/raw/100noqc_tp_ctx8192.json`
