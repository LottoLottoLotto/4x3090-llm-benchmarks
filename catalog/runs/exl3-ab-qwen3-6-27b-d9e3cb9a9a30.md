# `exl3-ab/llamacpp/q6k/sm-layer/pp32768`
...
| `output_tok_s` | 33.09 |
| `decode_tok_s` | 33.09 |
| `prefill_tok_s` | 1783.52 |

## Launch command

```bash
llama-bench -m ${MODEL_ROOT}/Qwen3.6-27B-MTP-GGUF/Qwen3.6-27B-Q6_K.gguf -p ... -n 256 -ngl 99 -fa 1 -ctk q8_0 -ctv q8_0 -sm layer -r 3
```
...
- `rig:~/benchmarks/exl3-ab/raw/llamacpp_q6k_layer.json`
