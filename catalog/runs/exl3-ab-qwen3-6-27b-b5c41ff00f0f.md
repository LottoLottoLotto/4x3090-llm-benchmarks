# `exl3-ab/exllamav3-0.0.43/043_single_ctx8192`
...
```bash
python exl3_bench.py --model ${MODEL_ROOT}/Qwen3.6-27B-exl3-6.0bpw --mode single --ctx 8192 --gen 256 --repeats 3 --cache-size 16384 --cache-mode q8
```
...
- `rig:~/benchmarks/exl3-ab/raw/043_single_ctx8192.json`
