# `laguna-dflash/dflash-k15/short-512x256-c4`
...
| metric | value |
|---|---:|
| `output_tok_s` | 113.53453678817598 |
| `decode_tok_s` | 32.13991145770385 |
| `prefill_tok_s` | 1004.7246871085832 |
| `total_tok_s` | 355.37751371123153 |
| `req_s` | 0.44349428432881244 |
| `ttft_p50_ms` | 574.4377064402215 |
| `ttft_p99_ms` | 1282.696715905331 |
| `itl_p50_ms` | 72.87172350334004 |
| `tpot_p50_ms` | 33.20996281553937 |
| `e2e_p99_ms` | 11004.832133161835 |
| `vram_peak_mib` | 92076 |
| `avg_power_w` | 797.928085106383 |
| `max_temp_c` | 74.0 |
...
```json
{
  "acceptance": 0.1017329255861366,
  "accepted_tokens_per_round": 1.525993883792049,
...
```json
{
  ...
  "num_prompts": 16,
  "output_tok_per_watt": 0.1422866783452535,
  "prefix_hit_rate": 0.029340974212034385,
  "throttle_sample_count": 144
}
```

## Provenance

- `repo:llm-bench/results/daily-papers/2026-07-22/laguna-s-2.1-dflash-4x3090/dflash-k15/short-512x256-c4.json`
