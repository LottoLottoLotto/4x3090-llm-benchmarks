# `laguna-dflash/dflash-k15/prefix-cold-131072x64`
...
| metric | value |
|---|---:|
| `output_tok_s` | 0.729800859946606 |
| `decode_tok_s` | 48.65007704560745 |
| `prefill_tok_s` | 1529.8873362399818 |
| `total_tok_s` | 1494.803208247199 |
| `req_s` | 0.01140313843666572 |
| `ttft_p50_ms` | 86399.4431210449 |
| `ttft_p99_ms` | 86399.4431210449 |
| `itl_p50_ms` | 42.55760449450463 |
| `tpot_p50_ms` | 20.554952031474503 |
| `e2e_p99_ms` | 87694.40509902779 |
| `vram_peak_mib` | 96036 |
| `avg_power_w` | 823.1177551020407 |
| `max_temp_c` | 76.0 |
...
```json
{
  "acceptance": 0.056862745098039215,
  "accepted_tokens_per_round": 0.8529411764705882,
...
```json
{
  ...
  "num_prompts": 1,
  "output_tok_per_watt": 0.0008866299571634604,
...
- `repo:llm-bench/results/daily-papers/2026-07-22/laguna-s-2.1-dflash-4x3090/dflash-k15/prefix-cold-131072x64.json`
