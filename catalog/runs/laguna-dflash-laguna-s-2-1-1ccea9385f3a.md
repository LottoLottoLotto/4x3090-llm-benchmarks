# `laguna-dflash/dflash-k7/short-512x256-c48`
...
| metric | value |
|---|---:|
| `output_tok_s` | 270.84387648140086 |
| `decode_tok_s` | 6.305108355822581 |
| `prefill_tok_s` | 382.2616399919792 |
| `total_tok_s` | 852.3272527341741 |
| `req_s` | 1.057983892505472 |
| `ttft_p50_ms` | 1692.9681209730916 |
| `ttft_p99_ms` | 15870.846583414823 |
| `itl_p50_ms` | 306.2686170451343 |
| `tpot_p50_ms` | 160.75938878028526 |
| `e2e_p99_ms` | 66782.63061904698 |
| `vram_peak_mib` | 96048 |
| `avg_power_w` | 844.2612565445025 |
| `max_temp_c` | 75.0 |
...
```json
{
  "acceptance": 0.2114311566882823,
  "accepted_tokens_per_round": 1.4800180968179761,
...
```json
{
  ...
  "num_prompts": 192,
  "output_tok_per_watt": 0.32080576288664997,
  "prefix_hit_rate": 0.029111309061273998,
  "throttle_sample_count": 725
}
```

## Provenance

- `repo:llm-bench/results/daily-papers/2026-07-22/laguna-s-2.1-dflash-4x3090/dflash-k7/short-512x256-c48.json`
