# `exl3-ab/exllamav3-1.0.0/q4_100_single_ctx2048_noint8`
...
```bash
python exl3_bench.py --model ${MODEL_ROOT}/Qwen3.6-27B-exl3-4.0bpw-mul1-v100 --mode single --ctx 2048 --gen 256 --repeats 3 --cache-size 8192 --cache-mode q8   [env: EXL3_INT8_GEMV=0]
```
...
- `rig:~/benchmarks/exl3-ab/raw/q4_100_single_ctx2048_noint8.json`
